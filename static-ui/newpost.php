		...
		<div class="jumbotron">
			<div class="container">
				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light">
					<a class="navbar-brand" href="index.php">LOUDER!</a>
				...
				<form>
					<div class="form-group">
						...
						<textarea class="form-control" id="formGroupExampleInput" placeholder="Tell your story"></textarea>
					</div>
					<div class="form-group">
				...
				<nav class="navbar fixed-bottom navbar-dark bg-primary">
					<a class="navbar-brand" href="#!">&#9400; LOUDER!</a>
				</nav>
